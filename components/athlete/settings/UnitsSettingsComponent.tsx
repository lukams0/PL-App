...
type UnitsSettingsProps = {
    handleBack: () => void;
    weightUnit: string;
    setWeightUnit: (s: SetStateAction<"kg" | "lbs">) => void;
    distanceUnit: string;
    setDistanceUnit: (s: SetStateAction<"imperial" | "metric">) => void;
    handleSave: () => void;

}

export default function UnitsSettingsComponent({
    handleBack,
    weightUnit,
    setWeightUnit,
    distanceUnit,
