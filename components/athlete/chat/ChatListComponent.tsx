...
export default function ChatListComponent({
    ...
    return (
        <SafeAreaView
            style={{ flex: 1, backgroundColor: '#f5f5f5' }} // 👈 grey like programs/history
            edges={['top', 'left', 'right']}                // no bottom inset -> flush with tab bar
        >
            <YStack f={1} backgroundColor="#f5f5f5">
                {/* Header */}
                <YStack
                    backgroundColor="#f5f5f5"     // 👈 no big white bar, just same grey
                    borderBottomWidth={1}
                ...
                <ScrollView
                    ...
                    contentContainerStyle={{
                        ...
                        paddingTop: 16,
                        paddingBottom: 0,   // 👈 avoid extra gap above tab bar
                    }}
                        ...
                        {loading ? (
                            ...
                            <YStack py="$12" ai="center" gap="$4">
                                ...
                                <YStack ai="center" gap="$2">
                                    ...
                                    <Text
                                        ...
                                        px="$6"
                                    >
                                        Start a conversation with other athletes or trainers
                                    </Text>
                                </YStack>
                                <Button
                                    size="$4"
                            ...
                            chats.map((chat) => (
                                <XStack
                                    ...
                                    gap="$3"
                                    borderRadius="$6"
                                    backgroundColor="white"   // 👈 cards stay white on grey background
                                    cursor="pointer"
                                >
                                    ...
                                    <YStack position="relative">
                                        <Avatar circular size="$6">
                                            {chat.userAvatar ? (
                                                <Avatar.Image src={chat.userAvatar} />
                                            ) : (
                                                <Avatar.Fallback
                                                    backgroundColor="#7c3aed"
                                                    ai="center"
