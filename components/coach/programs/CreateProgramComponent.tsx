            ...
            <XStack gap="$3">
              <YStack f={1} gap="$2">
                ...
                <Input
                  ...
                  onChangeText={(value) => handleUpdateBlock(block.id, { startWeek: Number(value) })}
                  keyboardType="numeric"
                  borderColor="#e9d5ff"
                  focusStyle={{ borderColor: '#7c3aed' }}
                />
              ...
              <YStack f={1} gap="$2">
                ...
                <Input
                  ...
                  onChangeText={(value) => handleUpdateBlock(block.id, { endWeek: Number(value) })}
                  keyboardType="numeric"
                  borderColor="#e9d5ff"
                  focusStyle={{ borderColor: '#7c3aed' }}
                />
          ...
          <YStack gap="$3">
            <Pressable onPress={() => setSelectedBlockId(selectedBlockId === block.id ? null : block.id)}>
              <XStack ai="center" jc="space-between">
                ...
                {selectedBlockId === block.id ? <ChevronDown size={20} /> : <ChevronRight size={20} />}
              </XStack>
            </Pressable>
